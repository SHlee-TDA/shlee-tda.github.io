...
This series of posts is designed to lay the introductory groundwork for **Topological Data Analysis** (TDA).

I think TDA is relatively less known for its attractiveness and achievements.
Therefore, whenever I present my research on TDA applications at various conferences, it is a challenge for me and my colleagues who work on TDA to explain the very basic concepts of TDA in a limited amount of time.
I hope that by the end of this series of posts, you will have the know-how to introduce the core ideas of TDA in a short time.

In the meantime, I've noticed that people who stumble upon TDA and want to get started often struggle with the lack of introductory material.
The mathematical concepts used in TDA are often difficult to grasp even for undergraduate math students.
In particular, one of the main tools used in TDA is persistent homology, which is intimidating because the name homology is already intimidating, but with the word persistence attached to it, how intimidating can it be?
Throughout this series of posts, I'll try to explain concepts like "**complex**", "**homology**", and "**persistent homology**" as easily as possible. 

However, there may still be some explanations that are difficult to understand due to my lack of "empathy" for non-mathematicians.
If you could leave a comment about that, I'd really appreciate it.
