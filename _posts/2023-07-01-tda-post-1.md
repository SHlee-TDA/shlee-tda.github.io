...
date: 2012-08-14
permalink: /posts/2023/07/tda-post-1/
tags:
...
This series of posts will introduce you to the basic concepts of **Topological Data Analysis** (TDA).

TDA is relatively unknown compared to its charm and performance. 
Therefore, whenever I presented my research on TDA at various conferences, it was a challenge for me to explain the basic concepts of TDA in a limited time frame. 
Through this series of posts, I hope you will learn how to introduce the core ideas of TDA in a short amount of time.

Meanwhile, those who are new to TDA and want to get started often struggle with a lack of introductory material. 
The mathematical concepts used in TDA are often difficult to understand even for college math students.
In this series of articles, I will try to explain concepts like "**chain complex**", "**homology**", and "**persistent homology**" as simply as possible.

However, there may be difficult explanations due to lack of understanding for non-mathematicians. 
I'd be grateful if you could leave a comment on that.
...
> 📌 **Keywords**
> - **Topology** : Topology: A branch of mathematics that deals with the connectivity of objects and their geometric properties, which do not depend on the coordinate system or the concept of distance.
> - **Simplicial Complex** : A generalization of a graph that represents the connectivity of an object. It represents high-dimensional connectivity using vertices, edges, faces, and high-dimensional analogues.
> - **Filtration** : An increasing sequence of subcomplexes that represents the evolutionary process of a simplicial complex.
> 
